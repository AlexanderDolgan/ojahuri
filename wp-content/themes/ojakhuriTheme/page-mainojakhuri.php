...
<section>
	...
	<section>
		<div class="container-fluid news-bg">
			<div class="row news">
				<h1 class="news-h1"><a href="<?php echo get_post_permalink( 'news' ); ?>"><?php echo get_cat_name( 10 ); ?></a>
				</h1>
					...
					<div class="news-article">
						<?php if ( have_posts() ) : query_posts( 'p=1051' );
							while ( have_posts() ) : the_post(); ?>
								...
								<h1 class="news-article-h1"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></h1>
...
<section class="white-section welcome animatedParent">
	<div class="container-fluid">
		<div class="row col-lg-8 col-md-10 col-lg-offset-2 col-md-offset-1 services-background">
			<div>
				<h1 class="section-heading animated fadeIn"><?php $idObj = get_category_by_slug('welcome'); $id = $idObj->term_id; echo get_cat_name( $id ) ?></h1>
				<hr>
			</div>
