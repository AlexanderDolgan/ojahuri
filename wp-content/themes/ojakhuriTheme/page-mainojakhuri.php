...
<section class="color-section">
    <div class="row">
        <div class="section-content-container col-md-8 col-md-offset-2">
            <h1>ОДЖАХУРИ</h1>
            <hr>
            <p>Пьянящий аромат поджаренного мяса... Приятно смешивающийся запах кавказских специй, лука и картофеля,
...
<!--service-boxes-->
<section class="white-section welcome">
    <div class="container">
        <div class="row">
            <div>
        ...
        <div class="section-content-container col-md-8 col-md-offset-2">
            <div class="call-to-action">
                ...
                <a href="https://www.facebook.com/ojakhuri?fref=ts"><i
                        class="fa fa-3x fa-facebook wow bounceIn"></i></a>
        ...
        <div class="courses-block">
            <div class="courses-box">
                ...
                <div class="courses-info">
                    <h3>Цыцыла «Чкмерули»</h3>

                    <p class="course-weigth">400/100 гр. <span class="course-price">490 Р</span></p>

                    <p class="course-description">Домашний цыпленок, запеченный с соусом на основе сметаны, с
                        добавлением
            ...
            <div class="courses-box">
                ...
                <div class="courses-info">
                    ...
                    <p class="course-description">Домашний цыпленок, запеченный с соусом </p>
                </div>
            </div>
        </div>
    </div>
